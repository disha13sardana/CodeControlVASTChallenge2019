...
namespace Scenes
{
    public class MapPlotFloorModel : Model
    {
        public const string PrefabName = "MapPlotPrefab";
        public int SerialId = 0;
        public Vector3 CenterPosition = new Vector3();
        public Vector3 Scale = new Vector3(10f, 0.1f, 10f);
        public Vector3 Rotation = Vector3.zero;
        public bool ShouldPlotLinePlots = true;
        public bool ShouldPlotDataSpheres = true;
        public bool ShouldPlotBarPlots = true;
